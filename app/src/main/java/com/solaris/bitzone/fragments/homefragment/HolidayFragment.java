...
public class HolidayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        back2= v.findViewById(R.id.arrowback2);
        ...
        TableLayout tl2 = (TableLayout) v.findViewById(R.id.table_m2);
        sharedpreferences.mRootRef.collection("holiday").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (DocumentSnapshot document : task.getResult()) {
                        ...
                        tv.setText(document.getId().toString().substring(2) +" : "+ document.getString("event"));
